...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		for (i = 0; i < n; i++) {
			...
			int roleId = Integer.parseInt(splited[0]);
			int privilegeId = Integer.parseInt(splited[1]);

			privilegeRole[i] = new PrivilegeRole(Role.getPrevilegeById(role, roleId),
					Privilege.getPrevilegeById(privilege, privilegeId));
		}
